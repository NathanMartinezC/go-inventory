...
import (
	...
	models "github.com/nathanmartinezc/go-inventory/internal/models"
)

var validRolesToAddProduct = [2]int64{1, 2}
var ErrInvalidPermissions = errors.New("user does not have permission to add products")
